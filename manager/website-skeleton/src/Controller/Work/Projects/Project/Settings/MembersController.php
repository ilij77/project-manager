...
class MembersController  extends AbstractController
{
	 ...
	 */
	public function revoke(Project $project, string  $member_id, Request $request, Membership\Remove\Handler $handler)
	{
		$this->denyAccessUnlessGranted(ProjectAccess::MANAGE_MEMBERS,$project);
	...
	/**
	 * @Route("/{member_id}",name=".show",requirements={"id"=Guid::PATTERN})
	 * @param Project $project
	 * @return Response
	 */
