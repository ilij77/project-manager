...
class Membership
{
	...
	*/
	...
	{
		$this->quardDepartments($departments);
		$this->quardRoles($roles);
	...
	public function quardDepartments(array $departments):void
	{
	...
	public function quardRoles(array $roles):void
	{
		if (\count($roles)===0){
