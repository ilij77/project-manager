...
class Project
{
	 ...
	 * @ORM\OneToMany(targetEntity="App\Model\Work\Entity\Projects\Project\Department\Department",mappedBy="project",orphanRemoval=true,cascade={"all"})
	...
	public function isMemberGranted(MemberId $id,string $permission)
	{foreach ($this->memberships as $membership){
		if ($membership->isForMember($id)){
