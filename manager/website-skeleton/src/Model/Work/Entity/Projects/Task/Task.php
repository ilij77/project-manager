...
/**
 * @ORM\Entity()
 * @ORM\Table(name="work_projects_tasks",indexes={@ORM\Index(columns={"date"})})
 */
class Task
{
	/**
	 ...
	 * @ORM\JoinTable(name="work_projects_tasks_executors",joinColumns={@ORM\JoinColumn(name="task_id",referencedColumnName="id")},
