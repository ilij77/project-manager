 ...
 */
final class Version20200219000623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN user_users.data IS \'(DC2Type:datetime_immutable)\'');
