 ...
 */
final class Version20200410221047 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE work_projects_tasks (id INT NOT NULL, project_id UUID NOT NULL, author_id UUID NOT NULL, parent_id INT DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, type VARCHAR(16) NOT NULL, priority SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, content TEXT DEFAULT NULL, progress SMALLINT NOT NULL, plan_date DATE DEFAULT NULL, status VARCHAR(16) NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, PRIMARY KEY(id))');
